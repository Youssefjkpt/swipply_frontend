...
class _MainSettingsState extends State<MainSettings> {
  ...
  String _makeAbsolute(String? path) {
    if (path == null || path.isEmpty) return '';
    return path.startsWith('http') ? path : '$BASE_URL_AUTH$path';
  }
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    // MainSettings::_avatar()
                    ClipRRect(
                      borderRadius: BorderRadius.circular(
                          100), // = full circle when width==height
                      child: FadeInImage.assetNetwork(
                        placeholder: progress,
                        image: _makeAbsolute(_profilePhotoPath),
                        height: 50,
                        width: 50,
                        fit: BoxFit.cover,
