...
import 'package:swipply/widgets/ai_auto_apply_notifiation_page.dart';
...
class DidYouKnowPersonalizeCard extends StatelessWidget {
  const DidYouKnowPersonalizeCard({super.key});
...
class FullApplicationsPage extends StatelessWidget {
  ...
  const FullApplicationsPage(this.applications, {super.key});
